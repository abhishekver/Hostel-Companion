...
function validation()
{
	...
	{
		alert("Login ID should'nt be empty..");
		return false;
	}
	else if(document.form1.oldpassword.value=="")
	{
		alert("Old password should'nt be empty..");
		return false;
	}
		else if(document.form1.newpassword.value=="")
	{
		alert("New password should'nt be empty..");
		return false;
	}
		else if(document.form1.cpassword.value=="")
	{
		alert("Confirm password should'nt be empty..");
		return false;
	}	
	...
	else if((document.form1.newpassword.value).length<8 || (document.form1.newpassword.value).strlen>15)
	{
		alert("Password length must be 8-15...");
		return false;
	}
	else if(!format.test(document.form1.newpassword)){
